...
<body>
    ...
    <div class="content-wrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($productos as $producto)
                                                        ...
                                                        <tr class="center-div-bar">
                                                            ...
                                                            <td id="estado" ><p style="{{ $estado }}">{{ $producto->stock }}</p></td>
        ...
        <div id="formularioEdicion">
            <form id="form_editar_servicios" method="post" action="{{ route('actualizarProductoVendedor') }}">
                @csrf
                <table class="table table-bordered table-hover form-edit" style="border: 8px solid #dee2e6;">
                    ...
                    <tbody class="form-edit">
                        ...
                        <tr>
                            <td><label for="proveedor">Cantidad:</label></td>
