                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola, <span>Bienvenido al exportador de archivos de datos de radicados</span></h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                                        ...
                                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                            <thead>
                                                <tr style="background: #e08eb1;" class="center-div-bar">
                                                    ...
                                                    <th style="color:#fff;">Tipo de solicitud</th>
                                            ...
                                            <tbody>
                                                @foreach ($radicados as $radicado)
                                                    <tr class="center-div-bar">
                                                        <td style="color: #000;">{{$radicado->num_servicio}}</td>
                                                        <td style="color: #000;">{{$radicado->nombre}}</td>
                                                        <td style="color: #000;">{{$radicado->email}}</td>
                                                        <td style="color: #000;">{{$radicado->motivo}}</td>
                                                        <td style="color: #000;">{{$radicado->detalle}}</td>
                                                        <td style="color: #000;">{{$radicado->estado}}</td>
                                                        <td style="color: #000;">{{$radicado->tipo_servicio}}</td>
                                                        <td style="color: #000; text-align:center;">{{$radicado->created_at}}</td>
