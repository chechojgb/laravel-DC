                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Hola, <span>Bienvenido al exportador de archivos de datos de productos</span></h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                                        ...
                                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                            <thead>
                                                <tr style="background: #e08eb1;" class="center-div-bar">
                                                    ...
                                                    <th style="color:#fff;">Cantidades disponibles</th>
                                            ...
                                            <tbody>
                                                @foreach ($productos as $producto)
                                                    ...
                                                    <tr class="center-div-bar">
                                                        <td style="color: #000;">{{$producto->nombre}}</td>
                                                        <td style="color: #000;">{{$producto->categoria}}</td>
                                                        <td style="color: #000;">{{number_format($producto->precio) }}</td>
                                                        <td style="color: #000;">{{$producto->stock}}</td>
                                                        <td style="color: #000;">{{$producto->detProducto->proveedor}}</td>
                                                        <td style="color: #000; text-align:center">{{$producto->estado}}</td>
                                                    </tr>
                                                @endforeach
